...
namespace BlazorApp.Proxies
{
    ...
    public partial class ProxyClient 
    {
        ...
        public virtual System.Threading.Tasks.Task<PostCollection> Posts_getAsync()
        {
            return Posts_getAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>The OK response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PostCollection> Posts_getAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/posts");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PostCollection>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class Metadata
    {
        ...
        [Newtonsoft.Json.JsonProperty("wpcom", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class PostCollection
    {
        ...
        public System.Collections.Generic.ICollection<PostItem> Posts { get; set; }
    ...
    public partial class PostItem
    {
        ...
        [Newtonsoft.Json.JsonProperty("excerpt", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
